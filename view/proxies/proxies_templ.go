...
func Proxy(proxy *models.Proxy) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		case models.Used:
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" class=\"flex items-center justify-between bg-gray-50 px-4 py-2 rounded-md\"><div class=\"flex items-center space-x-2\"><span class=\"h-3 w-3 rounded-full bg-blue-500\"></span> <span>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
